...
public class JobSchedulerDemoActivity extends AppCompatActivity {
    ...
    private static final String TAG = JobSchedulerDemoActivity.class.getSimpleName();
    ...
    public void cancelAllJobs(View v) {
        JobScheduler tm = (JobScheduler) getSystemService(Context.JOB_SCHEDULER_SERVICE);
        tm.cancelAll();
        Toast.makeText(JobSchedulerDemoActivity.this, R.string.all_jobs_cancelled, Toast.LENGTH_SHORT).show();
    }
    ...
    public void finishJob(View v) {
        ...
        if (allPendingJobs.size() > 0) {
            ...
            Toast.makeText(
                    JobSchedulerDemoActivity.this, String.format(getString(R.string.cancelled_job), jobId),
                    Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(
                    JobSchedulerDemoActivity.this, getString(R.string.no_jobs_to_cancel),
                    Toast.LENGTH_SHORT).show();
        }
    }
